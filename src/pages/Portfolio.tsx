...
export function Portfolio() {
  ...
  const portfolioItems = [{
    ...
    type: 'Gardening and Soil Health Article',
    ...
    description: 'Attic ventilation plays a key role in maintaining a safe and efficient home, yet it’s often overlooked. Proper airflow regulates temperature, controls moisture, and prevents long-term damage to insulation, roofing, and structural materials. Without it, heat and humidity can build up, leading to mold growth, wood rot, and higher energy costs. These issues often go unnoticed until signs like rising utility bills, musty odours, or roof damage appear.',
